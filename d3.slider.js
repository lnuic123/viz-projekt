...
return function module() {
    ...
    selection.each(function() {
      ...
      function onClickHorizontal() {
        if (toType(value) != "array") {
          ...
          moveHandle(scale.invert ? 
                    ...
                    : nearestTick(pos / sliderLength),1);
        }
      }
      ...
      function onClickVertical() {
        if (toType(value) != "array") {
          ...
          moveHandle(scale.invert ? 
                      stepValue(scale.invert(pos / sliderLength))
                    : nearestTick(pos / sliderLength),0);
        }
      }
  ...
  function moveHandle(newValue,dragflag) {
    ...
    if(dragflag != 0 && changevalue != newValue){
      ...
      svg1.selectAll("rect")
        .attr("stroke-opacity",function(d,i){
          return i == (newValue - 2000) ? "1" : "0";
        })
    }
    d3.select("#year").text("Year: " + newValue);
